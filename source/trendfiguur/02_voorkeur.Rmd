...
De "referentielijn" verwijst naar een relevant referentieniveau dat te kiezen is door de maker van de figuur.
...
De schaal en de aanwezigheid van referentielijnen ging af van de voorgaande keuzes van de deelnemers.
Zie §\@ref(02_voorkeur-individuele-voorkeur) voor een overzicht van de gemaakte keuzes.
...
De breedste lint omvat deelnemers die vertrouwd voelen met statistiek en cijfers en een voorkeur hebben voor een procentuele wijziging op de y-as, geannoteerde referentielijnen, onzekerheid als een band en geen symbolen.
De tweede breedste lint is een gelijkaardige groep maar met een voorkeur voor een index op de y-as.

...
data.frame(
  ...
  lcl = c(0.3, 0.2, 0.1, -0.1, -0.2, -0.3, -0.4, -0.1, -0.3, -0.3),
  ucl = c(0.4, 0.3, 0.2,  0.1, -0.1, -0.2, -0.3,  0.3,  0.1,  0.3)
) |>
  mutate(schatting = (.data$lcl + .data$ucl) / 2) |>
  ggplot(aes(ymin = lcl, ymax = ucl, x = effect, y = schatting)) +
...
## Overzicht van individuele voorkeuren {#02_voorkeur-02_voorkeur-02_voorkeur-02_voorkeur-02_voorkeur-individuele-voorkeur}

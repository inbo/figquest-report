...
Nadat de deelnemers hun voorkeur konden opgeven, vroegen we hen om opnieuw drie figuren te interpreteren voor de stijl van de figuren.
...
Indien we de stijl van de figuur in rekening brengen, zou de correctie interpretatie van de eerste reeks figuren steeds "geen idee" zijn.

```{r verklaring-beste, fig.cap = "Gemiddelde kans op een correcte interpretatie in functie van het gebruik van symbolen en de schaal van y-schaal. Het tweede reeks valt grotendeels samen met het toevoegen van referentielijnen en weergave van onzekerheid."}
voorspelling |>
  mutate(
